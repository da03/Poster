  ...
  \begin{columns}[t]
    \begin{column}{\onecolwid}
      ...
      \begin{block}{Tasks}
        ...
        \begin{figure}
          \begin{center}
            \includegraphics[width=\onecolwid]{im2text}
          \end{center}
        \end{figure}
        ...
        \begin{column}{\threecolwid}
          \begin{block}{State-of-the-art system}
            ...
            \begin{table}
              ...
              \end{tabular}
              \vskip1ex
              \caption{Best scores on English-German \emph{newstest2017}.}
            \end{table}
    ...
    \begin{column}{\onecolwid}
      ...
      \begin{block}{Additional resources}
        {\bf OpenNMT also provides additional resources including:}
        \vskip1ex

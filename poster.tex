  ...
  \begin{columns}[t]
    ...
    \begin{column}{\onecolwid}
      ...
      \begin{block}{Community}
        ...
        \begin{figure}
          \begin{center}
            ...
            \caption{GitHub statistics as July 18\textsuperscript{th}, 2017.}
          \end{center}
        \end{figure}
      ...
      \begin{block}{Open-source landscape}
        There exists several open-source alternatives that maintain a healthy competition and collaboration. Notable mentions are:
